...
int main(int argc, char** argv) {
    ...
    double total = strtod(argv[9], NULL) + strtod(argv[10], NULL) + strtod(argv[11], NULL);
    p0 = strtod(argv[9], NULL) / total;
    p1 = strtod(argv[10], NULL) / total;
    p2 = strtod(argv[11], NULL) / total;
